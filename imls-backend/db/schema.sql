...
--
-- Name: bin_devices_per_hour(timestamp with time zone, text); Type: FUNCTION; Schema: api; Owner: -
--

CREATE FUNCTION api.bin_devices_per_hour(_day timestamp with time zone, _fscs_id text) RETURNS TABLE(num_devices integer, hour timestamp with time zone)
    LANGUAGE plpgsql
    AS $$
